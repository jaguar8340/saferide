          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-4 rounded-lg" style={{ background: '#e8f8f5' }}>
                ...
                <p className="text-2xl font-bold" style={{ color: '#27ae60' }} data-testid="year-total-income">
              ...
              <div className="p-4 rounded-lg" style={{ background: '#fef5e7' }}>
                ...
                <p className="text-2xl font-bold" style={{ color: '#e67e22' }} data-testid="year-total-expense">
              ...
              <div className="p-4 rounded-lg" style={{ background: yearTotalBalance >= 0 ? '#e8f8f5' : '#fadbd8' }}>
                ...
                <p className="text-2xl font-bold" style={{ color: yearTotalBalance >= 0 ? '#27ae60' : '#c0392b' }} data-testid="year-total-balance">
