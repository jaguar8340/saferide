    ...
    <div className="min-h-screen" style={{ background: 'linear-gradient(135deg, #fff5f5 0%, #ffe8e8 50%, #fff 100%)' }}>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl sm:text-3xl font-bold" style={{ color: '#d63031' }}>Fahrzeugübersicht</h1>
            ...
            <DialogContent>
              ...
              <form onSubmit={handleVehicleSubmit} className="space-y-4">
                ...
                <Button type="submit" className="w-full" disabled={loading}>
                  {loading ? 'Speichern...' : (editingVehicle ? 'Aktualisieren' : 'Hinzufügen')}
                </Button>
              </form>
            </DialogContent>
          </Dialog>
            ...
            <Card key={vehicle.id} className="border-0 shadow-lg">
              ...
              <CardContent>
                <div className="flex justify-between items-center mb-4">
                  <h3 className="font-semibold">Service-Einträge</h3>
                ...
                {services[vehicle.id] && services[vehicle.id].length > 0 ? (
                  ...
                  <p className="text-gray-500 text-sm">Noch keine Service-Einträge</p>
                )}
              </CardContent>
            </Card>
          ))}
      ...
      <Dialog open={showServiceDialog} onOpenChange={setShowServiceDialog}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Service-Eintrag hinzufügen</DialogTitle>
          </DialogHeader>
